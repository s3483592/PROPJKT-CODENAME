  ...
  render(){    
    ...
    <header class="app-header">
      ...
      <nav class="app-top-nav">
        ...
        <a href="/removeUser" @click="${anchorRoute}">Delete User</a> 
        ` : ``}
                 
        <sl-dropdown>
          <a slot="trigger" href="#" @click="${(e) => e.preventDefault()}">
            <sl-avatar style="--size: 24px;" image=${(this.user && this.user.avatar) ? `${App.apiBase}/images/${this.user.avatar}` : ''}></sl-avatar> ${this.user && this.user.userName}
          </a>
          <sl-menu>            
    ...
    <sl-drawer class="app-side-menu" placement="left">
      ...
      <nav class="app-side-menu-items">
        ...
        ${this.user.accessLevel == 2 ? html`
        <a href="/admin" @click="${this.menuClick}">Admin Portal</a> 
        ` : ``}

...
class Auth {
  ...
  async signIn(userData) {
    ...
    _Toast.default.show("Welcome  ".concat(data.user.userName)); // save access token (jwt) to local storage
    ...
    // redirect to home or guide

    _Router.default.init(); //if user is new go to guide otherwise home
...
class GuideView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Guide\" user=\"", "\"></va-app-header>\n      <div class=\"page-content calign\">        \n        <h3 class=\"brand-color\">Welcome ", "!</h3>\n          <p>This is a quick tour to teach you the basics of using Chat7 ...</p>\n\n        <div class=\"guide-step\">\n          <h4>example</h4>\n              \n            </div>\n\n            \n\n            <sl-button type=\"primary\" @click=", ">Okay got it!</sl-button>\n                \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.userName, () => (0, _Router.gotoRoute)('/'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
},{"./bundle-url":"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"scss/master.scss":[function(require,module,exports) {
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./scss/master.scss":"scss/master.scss"}],"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
